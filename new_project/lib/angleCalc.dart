...
class LineChartSample9 extends StatelessWidget {
  ...
  void _initializeData() {
    _data["Line1"] = List.generate(7, (index) => FlSpot(index.toDouble(), (index + 1).toDouble()));
  ...
  void _updateData() {
    setState(() {
      _counter++;
      _data["Line1"]!.add(FlSpot(_counter.toDouble(), (_counter % 10).toDouble()));
    
      if (_data["Line1"]!.length > 10) {
